...
export function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 flex justify-around items-center py-1 z-50 md:hidden select-none h-14">
      <Link
        href="/notifications"
        className="flex flex-col items-center px-4 py-2 hover:text-orange-400 relative rounded-full"
      >
        {pathname === "/notifications" ? (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-7 h-7 text-orange-500 stroke-orange-500 stroke-1"
            viewBox="0 0 24 24"
          >
            <path
              fill="currentColor"
      ...
      <Link
        href="/home"
        className="flex flex-col items-center px-4 py-2 hover:text-orange-400 rounded-full"
      >
        {pathname === "/home" ||
